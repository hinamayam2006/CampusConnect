      ...
      <form onSubmit={onSubmit} className="bg-white p-3 p-md-4 rounded-3 shadow-sm border">
        ...
        <div className="row g-2 mb-3">
          ...
          <div className="col-md-6">
            ...
            <input className="form-control" value={vehicleInfo} onChange={(e) => setVehicleInfo(e.target.value)} placeholder="e.g. White Corolla" />
          </div>
        </div>
        <div className="mb-3">
          ...
          <div className="d-flex flex-wrap gap-2 mb-3">
            {DAYS.map((d) => (
              <button
                key={d.v}
                type="button"
                className={`btn btn-sm ${days.includes(d.v) ? 'btn-primary' : 'btn-outline-secondary'}`}
